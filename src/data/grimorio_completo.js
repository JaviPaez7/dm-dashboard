export const grimorioCompleto = [
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Un diamante con valor de al menos 1.000 po, 1 pulgada cúbica de carne de la criatura a clonar consumida en el lanzamiento y un recipiente con valor de al menos 2.000 po que tenga una tapa sellable y de tamaño suficiente para alojar a una criatura Mediana como una urna grande, un féretro, una zanja llena de barro en el suelo o un contenedor de cristal lleno de agua salada.",
    ritual: false,
    duration: "Instantáneo",
    concentration: false,
    casting_time: "1 hora",
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una estatuilla de ti mismo tallada en marfil y decorada con gemas, con un valor de al menos 1.500 po.",
    ritual: false,
    duration: "10 días",
    concentration: false,
    casting_time: "10 minutos",
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Polvo de rubí con un valor de 50 po que es consumido como parte del conjuro.",
    ritual: false,
    duration: "Hasta que sea disipado",
    concentration: false,
    casting_time: "1 acción",
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una gota de agua si estás creándola o unos granos de arena si la estás destruyendo.",
    ritual: false,
    duration: "Instantáneo",
    concentration: false,
    casting_time: "1 acción",
  ...
  },
  {
    ...
    name: "Cautivar",
    desc: [
      "Tejes una red de palabras de distracción, causando que las criaturas de tu elección que puedas ver dentro del alcance y que puedan oírte realicen una tirada de salvación de Sabiduría. Cualquier criatura que no pueda ser hechizada supera automáticamente la tirada de salvación, y si tú o tus compañeros estáis luchando contra uno de los objetivos, éste tiene ventaja en la tirada. Si un objetivo falla la tirada, tiene desventaja en las tiradas de Percepción hechas para percibir cualquier criatura distinta de ti hasta que el conjuro termine o hasta que el objetivo deja de poder oírte. El conjuro termina si eres incapacitado o dejas de poder hablar.",
    ],
    range: "60 pies",
    components: ["V", "S"],
    ritual: false,
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una representación del objetivo en forma de estatuilla tallada o dibujo en vitela, y un componente especial que varía según la versión del conjuro que elijas, con un valor de al menos 500 po por cada Dado de Golpe del objetivo.",
    ritual: false,
    duration: "Hasta que sea disipado",
    concentration: false,
    casting_time: "1 minuto",
  ...
  },
  {
    ...
    desc: [
      "Tocas a una criatura. La velocidad del objetivo aumenta en 10 pies hasta que el conjuro acabe.",
    ],
    higher_level: [
      "A Niveles Superiores. Cuando lanzas este conjuro usando un espacio de conjuro de nivel 2 o superior, puedes poner como objetivo a una criatura adicional por cada nivel de espacio mayor que 1.",
    ],
    range: "Toque",
    components: ["V", "S", "M"],
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una gema, cristal, relicario, u otro contenedor ornamental con un valor de al menos 500 po.",
    ritual: false,
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una joya con un valor de al menos 1.000 po, que es consumida como parte del conjuro.",
    ritual: false,
    duration: "24 horas",
    concentration: false,
    casting_time: "1 hora",
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Un diamante con un valor de al menos 1000 po que es consumido como parte del conjuro.",
    ritual: false,
    duration: "Instantáneo",
    concentration: false,
    casting_time: "1 hora",
  ...
  },
  {
    ...
    components: ["V", "M"],
    material:
      "La lengua de una serpiente y un trozo de panal o una gota de aceite dulce.",
    ritual: "No",
    duration: "Concentración hasta 8 horas",
    concentration: "Sí",
    casting_time: "1 acción",
  ...
  },
  {
    ...
    components: ["V", "S", "M"],
    material:
      "Una pizca de polvo resultante de machacar una gema transparente.",
    ritual: false,
    duration: "Concentración hasta 10 minutos",
    concentration: true,
    casting_time: "1 acción",
