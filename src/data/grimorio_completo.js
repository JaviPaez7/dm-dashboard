export const grimorioCompleto = [
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 3 o más, el daño (tanto el inicial como el posterior) aumenta en 1d4 por cada nivel por encima de 2 del espacio."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 3 o más, los puntos de golpe del objetivo aumentan en 5 más por cada nivel por encima de 2 que tenga el espacio que hayas empleado."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Una alarma mental te alerta con un sonido dentro de tu mente si estás a 1 milla de la zona vigilada. Este sonido te despertará si estás durmiendo.",
  ...
  },
  {
    ...
    "desc": [
      "Asumes un aspecto distinto. When you cast the spell, choose one of the following options, the effects of which last for the duration of the spell. While the spell lasts, you can end one option as an action to gain the benefits of a different one.",
  ...
  },
  {
    ...
    "higher_level": [
      "A niveles superiores, cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o superior, reanimas o reafirmas tu control sobre dos criaturas muertas vivientes adicionales por cada nivel del espacio de conjuro por encima del tercero. Cada criatura debe proceder de un cadáver o montón de huesos distinto."
    ],
    "range": "10 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Áreas de efecto mágico. El área de otro conjuro o efecto mágico, como una bola de fuego, no se extiende al interior de la esfera. Si la esfera se superpone con el área de un efecto mágico, este queda anulado en la parte del área cubierta por la esfera. Por ejemplo, las llamas creadas por un muro de fuego quedan suprimidas dentro de la esfera, creando un hueco en el muro si la superposición es suficientemente grande.",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Terminar el Efecto: Si una criatura afectada termina su turno a más de 60 pies del objetivo o no puede verlo, realiza una tirada de salvación de Sabiduría. Si tiene éxito, ya no estará afectada por el objetivo y reconocerá el sentimiento de antipatía o simpatía como mágico. Además, una criatura afectada por el conjuro puede realizar otra tirada de salvación de Sabiduría cada 24 horas mientras persista el efecto del conjuro.",
  ...
  },
  {
    ...
    "higher_level": [
      "A niveles superiores, cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más, el daño de la opción de Puño Cerrado aumenta en 2d8 y el daño de la opción de Mano Apresadora aumenta en 2d6 por cada nivel por encima del 5."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Implantas una ilusión en una criatura u objeto que tocas, de tal manera que los conjuros de adivinación proporcionan información falsa sobre este. El objetivo puede ser una criatura voluntaria o un objeto que puedas ver y que no lleve o vista otra criatura.",
  ...
  },
  {
    ...
    "name": "Perdición",
    "desc": [
      "Hasta tres criaturas de tu elección que puedas ver dentro del alcance deben hacer tiradas de salvación de Carisma. Siempre que un objetivo falle esta tirada de salvación al hacer una tirada de ataque o una tirada de salvación antes de que el conjuro termine, el objetivo debe tirar un d4 y restar el número obtenido de la tirada de ataque o de salvación."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro usando un espacio de conjuro de nivel 2 o superior, puedes afectar a una criatura adicional por cada nivel de espacio de conjuro por encima del primero."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "name": "Piel Robliza",
    "desc": [
      "Tocas a una criatura voluntaria. Hasta el final de la duración del conjuro la piel del objetivo se vuelve áspera con apariencia de corteza y su CA no podrá ser menor de 16, independientemente de la armadura que lleve."
    ],
    "range": "Toque",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "El conjuro levantarmaldición termina estos efectos. Bajo la discreción del DM puedes elegir un efecto alternativo para la maldición pero no debería ser más poderoso que los descritos más arriba. El DM tiene la última palabra sobre los efectos de una maldición."
    ],
    "higher_level": [
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "En falla, queda maldito por la duración del conjuro."
    },
    "school": {
      "index": "necromancy",
      "name": "Nigromancia",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "Una criatura apresada por los tentáculos puede usar su acción para hacer una prueba de Fuerza o Destreza (a su elección) contra tu CD de salvación de conjuros. Si tiene éxito, se libera."
    },
    "area_of_effect": {
      "type": "cuadrado",
      "size": 20
  ...
  },
  {
    ...
    "desc": [
      ...
      "Cuando una criatura entra en el área del muro por primera vez en un turno o cuando empiece su turno en ella, deberá realizar una tirada de salvación de Destreza. Si falla, sufrirá 6d10 de daño cortante. Si tiene éxito, recibirá la mitad de daño."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 5 o superior, el daño aumenta en 1d8 por cada nivel por encima del 4."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "A niveles superiores, cuando lanzas este conjuro empleando un espacio de conjuro de nivel 3 o superior, puedes afectar a una criatura adicional por cada nivel del espacio de conjuro que exceda el segundo."
    ],
    "range": "30 pies",
    "components": [
      "V"
  ...
  },
  {
    ...
    "desc": [
      ...
      "Si cuando lanzas este conjuro estás al aire libre y hay tormenta, el conjuro te da el control de esta en lugar de crear una nueva. Bajo estas condiciones, el daño del conjuro aumenta en 1d10."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más, el daño aumenta en 1d10 por cada nivel por encima del 3 que tenga el espacio que hayas empleado."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Intentas suprimir emociones fuertes en un grupo de gente. Cada humanoide en una esfera de 20 pies de radio centrada en un punto de tu elección dentro del alcance debe realizar una tirada de salvación de Carisma. Cualquiera de ellos puede elegir fallar la tirada voluntariamente si así lo desea. Si una criatura falla la tirada, elige uno de los dos efectos siguientes: Puedes suprimir cualquier efecto que mantenga al objetivo hechizado o asustado. Sin embargo, cuando este conjuro acabe, los efectos suprimidos vuelven a funcionar siempre que su duración no haya acabado.",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 7 o más un relámpago adicional salta del objetivo original a otro objetivo por cada nivel por encima de 6 que tenga el espacio que hayas empleado."
    ],
    "range": "150 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 2 o más, puedes elegir como objetivo a una criatura adicional por cada nivel por encima de 1 que tenga el espacio que hayas empleado. En el momento de elegirlas como objetivo, cada criatura debe estar a 30 pies o menos de todas las demás."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "name": "Clon",
    "desc": [
      "Este conjuro crea un duplicado inerte de una criatura viva como protección contra la muerte. El clon se forma dentro de un recipiente cerrado y crece hasta alcanzar la madurez en 120 días; también puedes optar por que el clon sea una versión más joven de la misma criatura. Se mantiene inerte y sobrevive indefinidamente, siempre y cuando el recipiente se mantenga intacto.",
      "En cualquier momento después de que el clon ha madurado, si la criatura original fallece, su alma se transfiere al clon, suponiendo que el alma esté libre y desee regresar, por supuesto. El clon es físicamente idéntico al original y posee la misma personalidad, memoria y habilidades, pero no conserva ningún equipo del original. Los restos físicos de la criatura original, si existen, se vuelven inertes y no pueden ser revividos ya que el alma de la criatura se encuentra en otro cuerpo."
    ],
    "range": "Toque",
    "components": [
      "V",
    ...
    "material": "Un diamante con valor de al menos 1.000 po, 1 pulgada cúbica de carne de la criatura a clonar consumida en el lanzamiento y un recipiente con valor de al menos 2.000 po que tenga una tapa sellable y de tamaño suficiente para alojar a una criatura Mediana como una urna grande, un féretro, una zanja llena de barro en el suelo o un contenedor de cristal lleno de agua salada.",
    "ritual": false,
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 hora",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "mitad",
      "desc": "La niebla afecta incluso a las criaturas que aguanten la respiración o que no necesiten respirar."
    },
    "area_of_effect": {
      "type": "esfera",
      "size": 20
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "half",
      "desc": "Una criatura que muera a causa de este conjuro se convertirá en una estatua helada hasta que se deshiele."
    },
    "area_of_effect": {
      "type": "cono",
      "size": 60
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 5 o más, el radio de la esfera aumenta en 5 pies por cada nivel por encima de 4 que tenga el espacio que hayas empleado."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Convocas espíritus feéricos que toman la forma de bestias y aparecen en espacios desocupados que puedas ver dentro del alcance. Elige una de las siguientes opciones para lo que convocas:",
      ...
      "Las bestias convocadas son amistosas hacia ti y tus compañeros. Las criaturas actúan como un grupo con sus propios turnos con una sola tirada de iniciativa común. Obedecen cualquier mandato verbal tuyo (no requiere acción). Si no les das ninguna orden, se defenderán de criaturas hostiles pero no realizarán ninguna otra acción.",
      "El DM tiene el perfil de las criaturas."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de determinados niveles superiores, el número de criaturas de la opción elegida aumenta: el doble con un espacio de conjuro de nivel 5, el triple con uno de nivel 7, y cuatro veces más con uno de nivel 9."
    ],
    "range": "60 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 9, invocas a un celestial con valor de desafío 5 o menos."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Invocas a una criatura feérica con valor de desafío 6 o menos o un espíritu feérico que toma la forma de una bestia con valor de desafío 6 o menos. Aparece en un espacio desocupado que puedas ver dentro del alcance. El feérico desaparece si sus puntos de golpe se reducen a 0 o el conjuro termina.",
      ...
      "Si tu concentración se rompe, el feérico no desaparece. En vez de eso pierdes el control del feérico, que se vuelve hostil hacia ti y tus compañeros y podría atacar. No puedes desconvocar al feérico descontrolado, que desaparecerá 1 hora después de que lo invoques.",
      "El DM tiene el perfil de las criaturas."
    ],
    "higher_level": [
  ...
  },
  {
    ...
    "desc": [
      ...
      "Un elemental convocado por este conjuro desaparece si llega a 0 puntos de golpe o cuando el conjuro termina.",
      "Las criaturas convocadas son amistosas hacia ti y tus compañeros. Las criaturas actúan como un grupo con sus propios turnos con una sola de tirada de iniciativa común. Obedecen cualquier mandato verbal tuyo (no requiere acción). Si no les das ninguna orden, se defenderán de criaturas hostiles pero no realizarán ninguna otra acción.",
      "El DM tiene el perfil de las criaturas."
    ],
    "higher_level": [
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de determinados niveles superiores el número de criaturas de la opción elegida aumenta: el doble si usas un espacio de conjuro de nivel 5, el triple si es de nivel 7 y cuatro veces más si es de nivel 9."
    ],
    "range": "60 pies",
    "components": [
      "V",
    ...
    "material": "Una baya de acebo por cada criatura convocada.",
    "ritual": false,
    "duration": "Concentración hasta 1 hora",
    "concentration": true,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Si fallas, recibes 6d6 de daño psíquico y quedas enloquecido hasta que termines un descanso largo."
    },
    "school": {
      "index": "divination",
      "name": "Adivinación",
  ...
  },
  {
    ...
    "desc": [
      ...
      "***Mal de ojo.*** La criatura comienza a sangrar incontrolablemente. Tiene desventaja en pruebas y tiradas de salvación de Constitución. Además, cada vez que la criatura recibe daño, queda aturdida hasta el final de su próximo turno."
    ],
    "range": "Toque",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Si supera tres tiradas el objetivo se recuperará de la enfermedad y el conjuro terminará."
    },
    "school": {
      "index": "necromancy",
      "name": "Nigromancia",
  ...
  },
  {
    ...
    "material": "Una estatuilla de ti mismo tallada en marfil y decorada con gemas, con un valor de al menos 1.500 po.",
    "ritual": false,
    "duration": "10 días",
    "concentration": false,
    "casting_time": "10 minutos",
  ...
  },
  {
    ...
    "higher_level": [
      "No se proporcionan detalles sobre la escalabilidad del conjuro con niveles superiores en la descripción, sigue siendo igual que describen los detalles base, donde los conjuros de un nivel menor o igual al nivel del espacio de conjuro utilizado no tienen efecto."
    ],
    "range": "60 pies",
    "components": [
      "S"
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 7 reanima o reafirma tu control sobre cuatro gules. Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 8 reanima o reafirma tu control sobre cinco gules o dos ghasts o tumularios. Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 9 reanima o reafirma tu control sobre seis gules, tres ghasts o tumularios, o dos momias."
    ],
    "range": "10 pies",
    "components": [
      "V",
    ...
    "school": {
      "index": "necromancy",
      "name": "Nigromancia",
      "url": "/api/magic-schools/necromancia"
    },
    "classes": [
      {
        "index": "cleric",
  ...
  },
  {
    ...
    "name": "Curar Heridas",
    "desc": [
      "Una criatura a la que toques recupera tantos puntos de golpe como 1d8 + tu modificador por aptitud mágica. Este conjuro no tiene efecto en muertos vivientes o autómatas."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro usando un espacio de conjuro de nivel 2 o más, la curación aumenta en 1d8 por cada nivel por encima del 1 que tenga el espacio que hayas empleado."
    ],
    "range": "Toque",
    "components": [
      "V",
  ...
  },
  {
    ...
    "material": "Ya sea una pizca de zanahoria seca o una ágata.",
    "ritual": false,
    "duration": "8 horas",
    "concentration": false,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Si el punto elegido es un objeto que tú sujetas o no lleva o viste nadie, la luz se extenderá desde el objeto y se desplazará con él. Cubrir completamente la fuente de luz con un objeto opaco, como una cazuela o un casco, la bloquea.",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 8 o más, el daño aumenta en 1d6 por cada nivel por encima de 7 que tenga el espacio que hayas empleado."
    ],
    "range": "150 pies",
    "components": [
      "V",
  ...
  {
    "index": "detectar-el-bien-y-el-mal",
  ...
  },
  {
    ...
    "desc": [
      "Durante la duración, puedes percibir la presencia de venenos, criaturas venenosas y enfermedades en un radio de 30 pies a tu alrededor. Además, también puedes identificar el tipo de veneno, criatura venenosa o enfermedad en cada caso.",
      "Este conjuro es capaz de atravesar la mayoría de las barreras, pero se ve bloqueado por 1 pie de piedra, 1 pulgada de cualquier metal común, una fina lámina de plomo o 3 pies de madera o tierra."
    ],
    "range": "Lanzador",
    "components": [
  ...
  },
  {
    ...
    "desc": [
      ...
      "***Romper encantamiento.*** Como acción, tocas a una criatura a tu alcance que esté hechizada, asustada o poseída por un celestial, elemental, feérico, infernal, o muerto viviente. La criatura que tocas ya no estará hechizada, asustada o poseída por dichas criaturas.",
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "El objetivo debe tener éxito en una tirada de salvación de Carisma o será enviado a su plano natal (si no está ya allí)"
    },
    "school": {
      "index": "abjuration",
      "name": "Abjuración",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "Si fracasa sufre un efecto en función de sus puntos de golpe actuales."
    },
    "school": {
      "index": "evocation",
      "name": "Evocación",
  ...
  },
  {
    ...
    "higher_level": [
      "Si utilizas un espacio de conjuro de nivel 9, la duración pasa a ser: concentración hasta 8 horas."
    ],
    "range": "60 pies",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "ninguno",
      "desc": "En caso de fracaso, la criatura queda hechizada por ti hasta el final de la duración."
    },
    "school": {
      "index": "enchantment",
      "name": "Encantamiento",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Mientras la criatura está hechizada posees un enlace telepático con ella siempre y cuando ambos os halléis en el mismo plano de existencia. Puedes usar este enlace para enviar órdenes al objetivo mientras estés consciente (no requiere acción) y este hará todo lo que esté en su poder para obedecer. Puedes especificar un procedimiento simple como \"ataca a esa criatura\", \"corre hasta allí\", o \"tráeme ese objeto\". Si la criatura cumple su orden y no recibe más mandatos de ti, se defiende y protege en la medida de sus posibilidades.",
      "Puedes utilizar tu acción para tomar un control total y preciso del objetivo. Hasta el final de tu próximo turno, la criatura solo realizará las acciones que elijas y no hará nada que no le permitas. Durante este tiempo también podrás hacer que el objetivo lleve a cabo reacciones pero eso hará que emplees también tu propia reacción.",
      "Cada vez que la criatura recibe daño, hace una nueva tirada de salvación contra el conjuro. Si tiene éxito, el efecto del conjuro termina."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6, la duración pasa a ser: concentración hasta 10 minutos. Si usas un espacio de conjuro de nivel 7, la duración pasa a ser: concentración hasta 1 hora. Si empleas un espacio de conjuro de nivel 8 o más, la duración pasa a ser: concentración hasta 8 horas."
    ],
    "range": "60 pies",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Cada vez que la criatura recibe daño, hace una nueva tirada de salvación contra el conjuro. Si tiene éxito, el efecto del conjuro termina."
    },
    "school": {
      "index": "enchantment",
      "name": "Encantamiento",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "Si falla, ecos de la monstruosidad fantasmal engendran una pesadilla que dura todo el tiempo de sueño restante del objetivo y le impide ganar beneficio alguno de su descanso."
    },
    "school": {
      "index": "illusion",
      "name": "Ilusión",
  ...
  },
  {
    ...
    "desc": [
      ...
      "- Creas un pequeño efecto sensorial inofensivo que predice el clima en tu ubicación durante las próximas 24 horas. El efecto podría manifestarse como un orbe dorado para cielos despejados, una nube para lluvia, copos de nieve para la nieve, y así sucesivamente. Este efecto persiste durante 1 asalto.",
      "- Haces que una flor brote instantáneamente, una vaina de semillas se abra, o un capullo de hoja florezca.",
      "- Creas un efecto sensorial instantáneo e inofensivo, como hojas cayendo, un soplo de viento, el sonido de un pequeño animal, o el leve olor de mofeta. El efecto debe caber en un cubo de 5 pies.",
  ...
  },
  {
    ...
    "higher_level": [
      "A niveles superiores, cuando lances este conjuro utilizando un espacio de conjuro de nivel 2 o más alto, los puntos de golpe temporales aumentan en 5 más por cada nivel por encima de 1 que tenga el espacio que hayas empleado."
    ],
    "range": "Lanzador",
    "components": [
      "V",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "En caso de fallo, una criatura suelta lo que sostenga y queda asustada por la duración."
    },
    "area_of_effect": {
      "type": "cono",
      "size": 30
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "El objetivo siempre recibe el daño. En caso de fallar la tirada de salvación, las puntuaciones de Inteligencia y Carisma de la criatura se convierten en 1."
    },
    "school": {
      "index": "enchantment",
      "name": "Encantamiento",
  ...
  },
  {
    ...
    "material": "10 po de carbón, incienso y hierbas que deben ser consumidas en el fuego de un brasero de bronce.",
    "ritual": true,
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 hora",
  ...
  },
  {
    ...
    "material": "Un juego de herramientas de adivinación - como huesos, palitos de marfil, cartas, dientes, o runas grabadas- con un valor de 100 po y un objeto del sitio que quieres hallar.",
    "ritual": false,
  ...
  },
  {
    ...
    "desc": [
      "Una tormenta de llamas surge rugiendo en una zona de tu elección dentro del alcance. El área de la tormenta está formada por hasta diez cubos de 10 pies que puedes colocar como desees. Cada cubo debe tener al menos una cara adyacente a una cara de otro cubo. Cualquier criatura que esté en el área debe hacer una tirada de salvación de Destreza. Sufrirá 7dl0 de daño de fuego si falla la tirada o la mitad del daño si la supera.",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más, el daño aumenta en 1d6 por cada dos niveles por encima de 2 que tenga el espacio que hayas empleado."
    ],
    "range": "Autolanzado",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más, el daño de fuego o radiante (a tu elección) aumenta en 1d6 por cada nivel por encima de 5 que tenga el espacio que hayas empleado."
    ],
    "range": "60 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "material": "Una pizca de cal, agua y tierra.",
    "ritual": false,
    "duration": "Concentración, hasta 1 minuto",
    "concentration": true,
    "casting_time": "1 acción",
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "En un fracaso, la criatura queda apresada mientras su carne comienza a endurecerse."
    },
    "school": {
      "index": "transmutation",
      "name": "Transmutación",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 7 o más el daño aumenta en 1d6 por cada nivel por encima de 6 que tenga el espacio que hayas empleado."
    ],
    "range": "300 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Todas las criaturas obedecen tus órdenes verbales y en combate, actúan en tu turno en cada asalto. El DJ tiene los perfiles de estas criaturas y resuelve sus acciones y movimientos.",
      ...
      "El DJ podría permitirte elegir objetivos distintos. Por ejemplo, si transformas a una abeja, su versión gigante puede tener el mismo perfil que una avispa gigante."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 7 o más, la barrera bloquea conjuros de un nivel más por cada nivel por encima de 6 del espacio de conjuro que utilices."
    ],
    "range": "Lanzador",
    "components": [
      "V",
  ...
  },
  {
    ...
    "name": "Guía",
    "desc": [
      "Tocas a una criatura dispuesta. Una vez antes de que el conjuro termine, el objetivo puede tirar un d4 y sumar el número tirado a una prueba de habilidad a su elección. Puede tirar el dado antes o después de realizar la prueba de habilidad. Entonces el conjuro termina."
    ],
    "range": "Toque",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 2 o superior, la curación aumenta en 1d4 por cada nivel de espacio de conjuro por encima del primero."
    ],
    "range": "60 pies",
    "components": [
      "V"
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 3 o más, el daño aumenta en 1d8 por cada nivel por encima de 2 que tenga el espacio que hayas empleado."
    ],
    "range": "60 pies",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Puede elegir no soltar el objeto"
    },
    "school": {
      "index": "transmutation",
      "name": "Transmutación",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 2 o más, el daño aumenta en 1d10 por cada nivel por encima de 1 que tenga el espacio que hayas empleado."
    ],
    "range": "60 pies",
    "components": [
      "V",
    ...
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 reacción que llevas a cabo cuando una criatura que puedas ver a 60 pies o menos te dañe",
    "level": 1,
    "damage": {
      "damage_type": {
        "index": "fire",
  ...
  },
  {
    ...
    "desc": [
      "Haces aparecer un gran festín, que incluye comida y bebida magníficas. Se tarda 1 hora en consumir el festín, el cual desaparece al cabo de ese tiempo. Los efectos beneficiosos no comienzan hasta que ha pasado esa hora. Hasta doce criaturas, además de ti, pueden participar del festín.",
      "Cualquier criatura que participe obtiene varios beneficios: queda curada de todas las enfermedades y veneno que la aquejan, es inmune al veneno y a ser asustada, y tiene ventaja en todas sus tiradas de salvación de Sabiduría. Además, sus puntos de golpe máximos aumentan en 2d10 y recupera la misma cantidad de puntos de golpe. Estos beneficios duran 24 horas."
    ],
    "range": "30 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más, puedes elegir como objetivo a una criatura adicional por cada nivel por encima de 5 que tenga el espacio que hayas empleado. En el momento de elegirlas como objetivo, todas las criaturas deben estar a 30 pies o menos de todas las demás."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Seleccionas a una criatura que puedas ver dentro del alcance y la marcas de manera mística como tu presa. Hasta que termine el conjuro, la criatura sufre 1d6 de daño adicional cuando la impactas con un ataque con arma y tienes ventaja en cualquier prueba de Sabiduría (Percepción) o Sabiduría (Supervivencia) realizada para encontrarla. Si los puntos de golpe del objetivo se reducen a 0 antes de que el conjuro finalice, puedes utilizar una acción adicional en un turno posterior para transferir la marca a una nueva criatura."
    ],
    "higher_level": [
      "Si empleas un espacio de conjuro de nivel 3 o 4, la duración aumenta a: concentración hasta 8 horas. Si usas un espacio de conjuro de nivel 5 o más, la duración aumenta a: concentración hasta 24 horas."
    ],
    "range": "90 pies",
    "components": [
      "V"
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "ninguno",
      "desc": "Si fallan, quedarán hechizadas hasta el final de la duración del conjuro."
    },
    "school": {
      "index": "illusion",
      "name": "Ilusión",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 5 o más, el daño contundente aumenta en 1d8 por cada nivel por encima del 4 que tenga el espacio que hayas empleado."
    ],
    "range": "300 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "***Contención mínima.*** El objetivo queda reducido a una altura de 1 pulgada y aprisionado dentro de una gema u objeto similar. La luz puede pasar a través de la gema con normalidad (permitiendo que el objetivo vea hacia fuera y otras criaturas puedan ver hacia dentro), pero nada más puede pasar a través, incluso por medios de teletransportación o viaje interplanar. La gema no puede ser cortada o rota mientras el conjuro se mantenga en efecto. El componente especial para esta versión del conjuro es una gran gema transparente, como un corindón, diamante, o rubí.",
      "***Sueño.*** El objetivo cae dormido y no puede ser despertado. El componente especial para esta versión del conjuro consiste en raros hierbas soporíferas.",
      "***Finalizar el Conjuro.*** Durante el lanzamiento del conjuro, en cualquiera de sus versiones, puedes especificar una condición que causará que el conjuro termine y libere al objetivo. La condición puede ser tan específica o elaborada como elijas, pero el GM debe acordar que la condición es razonable y tiene una probabilidad de ocurrir. Las condiciones pueden basarse en el nombre de una criatura, identidad, o deidad, pero por lo demás deben basarse en acciones u cualidades observables y no en intangibles tales como nivel, clase, o puntos de golpe.",
      "Un conjuro de disipar magia solo puede terminar el conjuro si se lanza como un conjuro de nivel 9, apuntando ya sea a la prisión o al componente especial utilizado para crearlo.",
      "Solo puedes usar un componente especial en particular para crear una prisión a la vez. Si lanzas el conjuro nuevamente usando el mismo componente, el objetivo de la primera lanzada es inmediatamente liberado de su atadura."
    ],
    "range": "30 pies",
    "components": [
      "V",
    ...
    "material": "Una representación del objetivo en forma de estatuilla tallada o dibujo en vitela, y un componente especial que varía según la versión del conjuro que elijas, con un valor de al menos 500 po por cada Dado de Golpe del objetivo.",
    "ritual": false,
    "duration": "Hasta que sea disipado",
    "concentration": false,
    "casting_time": "1 minuto",
    ...
    "dc": {
      ...
      "dc_success": "ninguno",
      "desc": "Si la criatura tiene éxito es inmune a este conjuro si vuelves a lanzarlo"
    },
    "school": {
      "index": "abjuration",
      "name": "Abjuración",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más, el daño aumenta en 1d10 por cada nivel por encima de 5 que tenga el espacio que hayas empleado."
    ],
    "range": "300 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      "Describe o nombra un tipo concreto de bestia o planta. Concentrándote en la voz de la naturaleza que te rodea, averiguas la dirección y distancia a la que se encuentra una criatura o planta del tipo escogido hasta un máximo de 5 millas, suponiendo que haya alguna."
    ],
    "range": "Lanzador",
    "components": [
      "V",
  ...
  },
  {
    ...
    "name": "Círculo Mágico",
    "desc": [
      "Creas un cilindro de energía mágica de 10 pies de radio y 20 pies de alto centrado en un punto del suelo que puedes ver dentro del alcance. Las intersecciones del cilindro con suelos o paredes quedan marcadas por una línea de runas brillantes.",
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más, la duración aumenta en 1 hora por cada nivel por encima del 3 que tenga el espacio que hayas empleado."
    ],
    "range": "10 pies",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Si intentan usar teletransportación o viaje interplanar para entrar, primero deben realizar una tirada de salvación de Carisma."
    },
    "school": {
      "index": "abjuration",
      "name": "Abjuración",
  ...
  },
  {
    ...
    "material": "Una gema, cristal, relicario, u otro contenedor ornamental con un valor de al menos 500 po.",
    "ritual": false,
    ...
    "dc": {
      ...
      "dc_success": "otro",
      "desc": "En caso de fallo, tu alma se mueve al cuerpo del objetivo, y el alma del objetivo queda atrapada en el contenedor. En caso de éxito, el objetivo resiste tus esfuerzos por poseerlo, y no puedes intentar poseerlo nuevamente durante 24 horas."
    },
    "school": {
      "index": "necromancy",
      "name": "Nigromancia",
  ...
  },
  {
    ...
    "material": "Un trocito de panal de abeja y polvo de jade con un valor de al menos 10 po que es consumido como parte del conjuro.",
    "ritual": true,
    "duration": "Hasta que sea disipado",
    "concentration": false,
    "casting_time": "1 minuto",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más, el conjuro se mantiene hasta que sea disipado, sin requerir concentración."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 6 o más la curación aumenta en 1d8 por cada nivel por encima de 5 que tenga el espacio que hayas empleado."
    ],
    "range": "60 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más, la curación aumenta en 1d4 por cada nivel por encima de 3 que tenga el espacio que hayas empleado."
    ],
    "range": "60 pies",
    "components": [
      "V"
  ...
  },
  {
    ...
    "desc": [
      "Tres duplicados ilusorios de ti mismo aparecen en tu espacio. Hasta el final del conjuro, se mueven contigo e imitan tus acciones, cambiando de posición y haciendo imposible saber cuál imagen es la real. Puedes utilizar tu acción para hacer desaparecer los duplicados.",
      "Cada vez que una criatura te elija como objetivo de un ataque mientras el conjuro esté activo, tira un d20 para determinar si el ataque en realidad tiene como objetivo a uno de tus duplicados.",
      "Si tienes tres duplicados, sacando un 6 o más cambia el objetivo a un duplicado en lugar de a ti. Con dos duplicados, sacando un 8 o más. Con un duplicado, sacando un 11 o más.",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro usando un espacio de conjuro de nivel 5 o superior, el daño aumenta en 1d10 por cada nivel del espacio del conjuro que exceda el 4."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "Si fracasa, es transportada a una localización aleatoria del plano de existencia que elijas. Una criatura transportada de esta manera debe encontrar su propio camino de vuelta a tu plano actual."
    },
    "school": {
      "index": "conjuration",
      "name": "Conjuración",
  ...
  },
  {
    ...
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 acción u 8 horas",
    "level": 3,
    "school": {
      "index": "transmutation",
      "name": "Transmutación",
  ...
  },
  {
    ...
    "desc": [
      ...
      "El daño del conjuro aumenta en 1d12 cuando alcanzas el nivel 5 (2d12), nivel 11 (3d12) y nivel 17 (4d12)."
    ],
    "range": "10 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 3 o más, la curación aumenta en 1d8 por cada nivel por encima de 2 que tenga el espacio que hayas empleado."
    ],
    "range": "30 pies",
    "components": [
      "V"
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Para cada objetivo tira un d8 para determinar qué rayo le afecta."
    },
    "area_of_effect": {
      "type": "cono",
      "size": 60
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 5 o más, el lado máximo del cubo aumenta en 100 pies por cada nivel por encima de 4 del espacio. Por tanto, utilizando un espacio de conjuro de nivel 5 puedes proteger una zona equivalente a un cubo de hasta 200 pies de lado."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "material": "Agua bendita o plata y hierro pulverizados que son consumidos como parte del hechizo.",
    "ritual": false,
    "duration": "Concentración hasta 10 minutos",
    "concentration": true,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "desc": [
      ...
      "La magia fabrica un nuevo cuerpo para que sea habitado por la criatura, lo que probablemente haga que su raza cambie. El DJ lanza 1d100 y consulta en la siguiente tabla para determinar qué forma adoptará la criatura al ser devuelta a la vida. También puedes elegir una forma concreta en vez de tirar.",
      "| d100 | Raza |",
      "|---|---|",
      "| 01-04 | Dracónido |",
  ...
  },
  {
    ...
    "material": "Una pieza semiesférica de cristal transparente y una pieza semiesférica de goma arábica que encaje con la anterior.",
    "ritual": false,
    "duration": "Concentración hasta 1 minuto",
    "concentration": true,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "material": "Un diamante con un valor de al menos 1000 po que es consumido como parte del conjuro.",
    "ritual": false,
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 hora",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "other",
      "desc": "Una criatura puede realizar una tirada de salvación de Destreza para agarrarse a un objeto fijado al suelo que esté a su alcance lo que le permitirá evitar la caída si tiene éxito en dicha tirada."
    },
    "area_of_effect": {
      "type": "cylinder",
      "size": 50
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 3 o más creas un rayo adicional por cada nivel por encima de 2 del espacio."
    ],
    "range": "120 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "material": "Un cofre de manufactura exquisita cuyas dimensiones sean de 3 pies por 2 pies por 2 pies, construido de materiales exóticos con un valor de al menos 5.000 po, así como una réplica diminuta hecha de los mismos materiales y con un valor de al menos 50 po.",
    "ritual": false,
    "duration": "Instantáneo",
    "concentration": false,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Los cambios realizados por este conjuro no resisten una inspección física. Por ejemplo, si usas este conjuro para añadir un sombrero a la vestimenta de una criatura, los objetos pasan a través del sombrero y cualquiera que lo toque no sentiría nada o sencillamente notaría el pelo y cabeza. Si utilizas este conjuro para parecer más delgado, la mano de cualquiera que intente tocarte se chocará contigo mientras parece estar aún en el aire.",
  ...
  },
  {
    ...
    "desc": [
      "Eliges a una criatura u objeto no mágico que puedas ver dentro del alcance. Puedes transformar a la criatura en una criatura diferente, o en un objeto o al objeto en una criatura (siempre que nadie esté vistiendo o portando este objeto). La transformación se mantiene hasta el fin de la duración del conjuro, o hasta que el objetivo muera o sea reducido a 0 puntos de vida. Si mantienes tu concentración en el conjuro durante toda su duración, la transformación permanece hasta que sea disipada.",
      "El conjuro no afecta a cambiaformas o a criaturas con 0 puntos de vida. Un objetivo que no desee ser afectado puede realizar una tirada de salvación de Carisma, y si tiene éxito, no será afectado por el conjuro.",
      "Si conviertes una criatura en otra criatura, la nueva forma puede ser cualquier criatura cuyo valor de desafío sea igual o menor que el del objetivo o igual o menor que el nivel del objetivo si este no posee un valor de desafío. Reemplazas el perfil de estadísticas del objetivo con el de la forma elegida, incluyendo puntuaciones de características mentales, pero mantiene su alineamiento y personalidad. Adquiere los puntos de vida de su nueva forma y, al revertir a su forma normal, regresa a los puntos de vida que tenía antes de la transformación. Si la transformación se termina por quedarse sin puntos de vida, cualquier daño restante se aplica a la forma normal. Si este daño restante no reduce la forma normal de la criatura a 0 puntos de vida, no cae inconsciente.",
      "Las acciones de la criatura están limitadas por la naturaleza de su nueva forma y no puede hablar, lanzar conjuros, o realizar cualquier acción que requiera hablar o el uso de las manos, a menos que su nueva forma sea capaz de estas acciones."
    ],
    "range": "Self",
    "components": [
      "V",
    ...
    "material": "Una gota de mercurio, una migaja de goma arábica y un hilillo de humo",
    "ritual": false,
    "duration": "Concentración, hasta 1 hora",
    "concentration": true,
    "casting_time": "1 acción",
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro usando un espacio de conjuro de nivel 3 o superior, el daño del conjuro aumenta en 1d8 por cada nivel del espacio de conjuro por encima del 2."
    ],
    "range": "60 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "subclasses": [
      {
        "index": "lore",
        "name": "Tradición del Conocimiento",
        "url": "/api/subclasses/lore"
      }
    ],
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 2 o más, tira 2d8 adicionales por cada nivel por encima de 1 que tenga el espacio que hayas empleado."
    ],
    "range": "90 pies",
    "components": [
      "V",
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "En caso de fallo en la salvación, la criatura se ralentiza."
    },
    "area_of_effect": {
      "type": "cube",
      "size": 40
  ...
  },
  {
    ...
    "desc": [
      "Invocas a los espíritus para que te protejan. Estos revolotean alrededor tuyo moviéndose en un radio de 15 pies hasta que finaliza el conjuro. Si eres bueno o neutral, su forma espectral es angelical o feérica, según elijas. Si eres malvado, su forma es infernal.",
      "Al lanzar este conjuro, puedes elegir cualquier número de criaturas que veas para que no sean afectadas. La velocidad de una criatura afectada se reduce a la mitad en el área. Cuando una criatura entra por primera vez en el área o comienza su turno en ella, debe realizar una tirada de salvación de Sabiduría. Si falla, recibe 3d8 de daño radiante (si eres bueno o neutral) o 3d8 de daño necrótico (si eres malvado). Si la supera, recibe la mitad del daño."
    ],
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más, el daño aumenta en 1d8 por cada nivel por encima del tercer nivel que uses."
    ],
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "ninguno",
      "desc": "Si fracasa empleará su acción del turno en tambalearse y vomitar."
    },
    "area_of_effect": {
      "type": "sphere",
      "size": 20
  ...
  },
  {
    ...
    "desc": [
      ...
      "Asalto 2. Una lluvia ácida cae de la nube. Todas las criaturas debajo de ella reciben 1d6 de daño de ácido.",
      "Asalto 3. Llamas a seis relámpagos que surgen de la nube para electrocutar a seis criaturas u objetos de tu elección que estén debajo de ella. Cada objetivo no puede ser impactado por más de un relámpago. Las criaturas atacadas deben hacer una tirada de salvación de Destreza. Sufrirán 10d6 de daño de relámpago si fallan la tirada o la mitad del daño si la superan.",
      "Asalto 4. Enormes piedras de granizo se precipitan desde las nubes. Todas las criaturas debajo de ellas reciben 2d6 de daño contundente.",
      "Asaltos 5 a 10. Ráfagas de viento y una lluvia helada asaltan a las criaturas bajo las nubes. La zona cubierta se considera muy oscura y terreno difícil. Todas las criaturas debajo de ella reciben 1d6 de daño de frío. No se pueden realizar ataques con arma a distancia en el área. El viento y la lluvia cuentan como una distracción severa a la hora de mantener la concentración en un conjuro. Por último, las ráfagas de viento fuerte (desde 20 a 50 millas por hora) dispersan automáticamente niebla, brumas y fenómenos similares en el área, ya sean mundanos o mágicos."
    ],
    "range": "Vista",
    "components": [
      "V",
    ...
    "dc": {
      ...
      "dc_success": "none",
      "desc": "Si fallan la tirada sufrirán 2d6 de daño de trueno y quedarán ensordecidas durante 5 minutos."
    },
    "area_of_effect": {
      "type": "sphere",
      "size": 360
  ...
  },
  {
    ...
    "dc": {
      ...
      "dc_success": "half",
      "desc": "En un fallo, la criatura también queda cegada por 1 minuto."
    },
    "area_of_effect": {
      "type": "cylinder",
      "size": 60
    ...
    "subclasses": [],
    "url": "/api/spells/explosion-solar"
  },
  {
    "index": "symbol",
    "name": "Símbolo",
    "desc": [
      ...
      "Muerte. Cada objetivo debe hacer una tirada de salvación de Constitución, sufriendo lOdlO de daño de necrótico si falla, o la mitad del daño si la supera.",
  ...
  },
  {
    ...
    "desc": [
      ...
      "***Familiaridad.*** \"Círculo permanente\" se refiere a un círculo de teletransportación permanente cuya secuencia de sellos conoces. \"Objeto asociado\" quiere decir que posees un objeto recogido en la localización deseada en los últimos seis meses como un libro de la biblioteca de un mago, sábanas de una suite real o un trozo de mármol de la tumba secreta de un liche.",
  ...
  },
  {
    ...
    "school": {
      "index": "transmutación",
      "name": "Transmutación",
      "url": "/api/magic-schools/transmutación"
    },
    "classes": [
      {
        "index": "clérigo",
        "name": "Clérigo",
        "url": "/api/classes/clérigo"
      }
    ],
    "subclasses": [
      {
  ...
  },
  {
    ...
    "higher_level": [
      "Cuando lanzas este conjuro utilizando un espacio de conjuro de nivel 4 o más el daño aumenta en 1d6 por cada nivel por encima de 3 que tenga el espacio que hayas empleado."
    ],
    "range": "Lanzador",
    "components": [
      "V",
  ...
  },
  {
    ...
    "desc": [
      ...
      "Cualquier criatura que comience su turno en las telarañas o que entre en ellas durante el mismo debe hacer una tirada de salvación de Destreza. Si la falla, quedará apresada mientras siga en las telarañas o hasta que se libere.",
      "Una criatura apresada puede utilizar su acción para hacer una prueba de Fuerza contra tu CD de salvación de conjuro. Si la supera, dejará de estar apresada.",
  ...
  },
  {
    ...
    "desc": [
      ...
      "- Deshaces un hecho reciente forzando la repetición de una tirada hecha durante el último asalto (incluyendo tu último turno). La realidad se remodela para acomodar el nuevo resultado. Por ejemplo, un conjuro de deseo podría deshacer con éxito una tirada de salvación de un oponente, un golpe crítico de un enemigo o una tirada de salvación fallida de un amigo. Puedes obligar a que la tirada se repita con ventaja o desventaja, y puedes elegir si usar el resultado de la repetición o el original.",
      "Podrías lograr algo más allá del alcance de los ejemplos anteriores. Expresa tu deseo al Director de Juego tan precisamente como sea posible. El Director de Juego tiene mucha libertad para determinar qué sucede en tales casos; cuanto más grande sea el deseo, más probable es que algo salga mal. Este conjuro podría simplemente fallar, el efecto deseado podría alcanzarse solo parcialmente, o podrías sufrir alguna consecuencia imprevista como resultado de cómo formulaste el deseo. Por ejemplo, desear que un villano esté muerto podría transportarte hacia adelante en el tiempo a un período cuando ese villano ya no está vivo, sacándote efectivamente del juego. De manera similar, desear un objeto mágico legendario o un artefacto podría transportarte instantáneamente a la presencia del poseedor actual del objeto.",
      "El esfuerzo de lanzar este conjuro para producir cualquier efecto que no sea duplicar otro conjuro te debilita. Después de hacer frente a ese estrés, cada vez que lances un conjuro hasta que completes un descanso largo, recibirás 1d10 de daño necrótico por nivel de ese conjuro. Este daño no puede ser reducido ni prevenido de ninguna manera. Además, tu Fuerza se reduce a 3, si no es ya 3 o menos, durante 2d4 días. Por cada uno de esos días que pases descansando y realizando únicamente actividades ligeras, tu tiempo de recuperación se reduce en 2 días. Finalmente, hay un 33% de posibilidades de que no puedas volver a lanzar deseo nunca más si sufres este estrés."
    ],
    "range": "Lanzador",
    "components": [
      "V"
  ...
  },
  {
    ...
    "desc": [
      "Tú y hasta cinco criaturas voluntarias a 5 pies de ti os teleportáis instantáneamente a un santuario designado previamente. Apareceréis en el espacio libre más cercano al punto que elegiste al preparar tu santuario (ver más abajo). Si lanzas este conjuro sin haber dispuesto un santuario primero, este no tendrá ningún efecto.",
